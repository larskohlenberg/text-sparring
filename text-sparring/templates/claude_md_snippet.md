...
2. Falls `Dran: {MY_NAME}` → erledige den ausstehenden Schritt nach den Regeln in `sparring/CHALLENGE.md`, aktualisiere `state.md` (Dran, Verlauf, ggf. neue Runde anlegen), starte dann den Wait-Loop.
